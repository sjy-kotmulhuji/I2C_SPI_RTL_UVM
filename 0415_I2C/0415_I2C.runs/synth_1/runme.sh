...
HD_PWD='D:/ondevice_sjy/0415_I2C/0415_I2C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_demo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_demo_top.tcl
