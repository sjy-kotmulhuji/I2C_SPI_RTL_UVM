...
HD_PWD='D:/ondevice_sjy/0415_I2C/0415_I2C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_demo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_demo_top.tcl -notrace
